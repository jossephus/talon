...
pub const ForeignMethodBindings = std.StaticStringMap(?*const WrenForeignMethodFn).initComptime(.{
    ...
    .{ "raylib.Vector3.x", RaylibBindings.Vector2.get_x },
    .{ "raylib.Vector3.x=(_)", RaylibBindings.Vector2.set_x },
    .{ "raylib.Vector3.y", RaylibBindings.Vector2.get_y },
    .{ "raylib.Vector3.y=(_)", RaylibBindings.Vector2.set_y },
